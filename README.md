...
- **Shared needs and economy:** all dwarfs need wages, beds, food, and appropriate facilities. Miners deliver finite gold-seam yields and renewable, slower gem-column yields to Treasure Rooms; both produce the same gold currency. Dwarfs collect pay there. Stonehands cost a flat 25 gold and have no living expenses; the dwarf Miner is retained for later reuse.
