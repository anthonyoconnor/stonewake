...
**Debug → Test harnesses → M33 lighting test room** provides a paused furnished settlement, lava/water crossings and a sealed fog pocket. Adjust ambient/source light, glow and pointer illumination, choose a camera view, compare the current renderer, reset, or return to your retained stronghold. During development, `?scenario=lighting&paused=1` opens it directly. The [lighting experiment](graphics-pass.md#m33-lighting-test-room) is implemented; full M33 biome and campaign lighting remains planned.
