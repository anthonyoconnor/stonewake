...
| Library | Kitchen |
|---|---|
| [![Four Library layouts](library-v3.png)](library-v3.png) | [![Four Kitchen layouts](kitchen-v3.png)](kitchen-v3.png) |
...
|---|---|
| [![Four Workshop layouts](workshop-v3.png)](workshop-v3.png) | [![Four Training Room layouts](training-room-v3.png)](training-room-v3.png) |
| **[Workshop](workshop-v3.png):** compact benches and anvils expand into door and trap assembly areas. Tool boards and brass floor markings identify the combined craft facility. | **[Training Room](training-room-v3.png):** practice stations, targets, and exercise space fit around clear routes. Every current dwarf type can train here; sleeping remains in Dormitories. |

## Storage and accommodation

| Treasure Room | Dormitory |
|---|---|
| [![Four Treasure Room layouts](treasure-room-v3.png)](treasure-room-v3.png) | [![Four Dormitory layouts](dormitory-v3.png)](dormitory-v3.png) |
...
[![Four Guard Post layouts](guard-post-v3.png)](guard-post-v3.png)
...
| Stone Hearth | Bridge |
|---|---|
| [![Four Stone Hearth placement contexts](stone-hearth-v2.png)](stone-hearth-v2.png) | [![Four Bridge layout concepts](bridge-v2.png)](bridge-v2.png) |
...
Superseded sheets have been removed from the working gallery. The previous set is available in Git history at commit `26bf924`; filenames in historical prompts identify the actual inputs used. The gallery contains nine current room/structure sheets and the updated terrain-grid study.
