...
- **Terrain:** subtly chamfered full-height banks and shallow exposed stone relief replace perfectly flat block faces. Generated clod/slate textures distinguish earth, rock and bedrock; fitted claimed paving remains distinct from rough unclaimed ground. Connected gold veins now branch over tops and exposed faces. Gem deposits retain their permanent dark square columns with blue/violet faceted quartz.
