...
|---|---|---|---|---|---|---|---|
| Cave Hound | Scouts open routes and watches the Hearth | Early melee defense and Call to Arms | Dormitory-only automatic arrival; shared animal quota | None | One den place | Fed at its Dormitory den | No special room |
| Stonehand | Shared terrain work: mine, haul, claim, reinforce, walls and bridges | Fragile, cannot fight | Starting crew or Create Stonehand (25 gold) | None | None | None | Hearth arrival and reachable storage |
| Miner (legacy) | Excavates designated terrain, extracts resources, delivers gold, claims reachable ground, and reinforces walls when other work is complete | Opens routes; adjacent self-defense without pursuit; retreat remains proposed | Retained for debug; future basic fighter role deferred | Low tier; regular payday | One Dormitory accommodation slot | One Kitchen support slot; autonomous eating visits | None; works on terrain and needs access to treasure storage |
