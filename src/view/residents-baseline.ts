...
import {residentSurface,costumeDetails} from './resident-detail-baseline';
import {createStonehandModel} from './stonehands-baseline';
import {createHoundModel,animateHound,type HoundRig} from './hounds-baseline';
