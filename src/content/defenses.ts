...
export const defenseDefinitions:DefenseDefinition[]=[
  ...
  {id:'bolt-trap',name:'Bolt trap',kind:'bolt',damage:30,cooldown:3,range:7,description:'Fires at the first enemy along its facing. Walls, furniture and shut doors stop shots. Resets automatically.'}
];
...
export const raiderDefinition={health:120,speed:1.2,damage:20,attackSeconds:1};
