...
export const tuningSpec={
 ...
 securityMemorySeconds:value(20,'Threat report lifetime · seconds','Exploration',3,120,1,'Dogs investigate last reported positions; unseen enemies are never tracked through fog.'),
 securityRunMultiplier:value(1.5,'Emergency running speed multiplier','Movement',1,3,.1,'Hounds answering threats and mining workers escaping danger.'),
 workerThreatRadius:value(4,'Worker danger distance · tiles','Movement',1,10,.5,'Nearby visible enemies interrupt mining work.'),
 workerSafeSeconds:value(5,'Worker safety pause · seconds','Movement',1,30,1,'Wait after escaping before taking a safe job.'),
 ...
 minerMinimumCost:value(50,'Stonehand base creation cost · gold','Economy & world',0,10000,1,'Base + population step per living Stonehand, including the starting crew. Also used by legacy Miner recruitment.'),
 minerCostStep:value(25,'Creation cost per living Stonehand · gold','Economy & world',1,10000,1,'Applies live to the next creation price. Destroyed Stonehands no longer count; other unit types do not count.'),
