...
export const tuningSpec={
 ...
 wageGraceSeconds:value(45,'Overdue wage warning after · seconds','Economy & world',0,600,1,'Allows ordinary travel and queues before warning. No departure penalty yet.'),
