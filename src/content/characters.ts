export interface CharacterDefinition {id:string;name:string;names:string[];color:string;speedMultiplier:number;capabilities:string[];appearance:'helmet'|'braids'|'warrior'|'runesmith';attractionServices:string[]}
export const characterDefinitions:CharacterDefinition[]=[
  ...
  {id:'warrior',name:'Warrior',names:['Dagna','Torvald','Brynja'],color:'#954d37',speedMultiplier:1,capabilities:[],appearance:'warrior',attractionServices:['training']},
