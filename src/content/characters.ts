...
export interface CharacterDefinition {
  ...
  attractionServices:string[]; wage:number; levels:CharacterLevel[];
}
export const characterDefinitions:CharacterDefinition[]=[
  {id:'miner',name:'Miner',names:['Brokk','Orin','Thora'],color:'#b78638',speedMultiplier:1,wage:4,
  ...
  {id:'engineer',name:'Engineer',names:['Helga','Sigrid'],color:'#357a81',speedMultiplier:1,wage:7,
  ...
  {id:'warrior',name:'Warrior',names:['Dagna','Torvald','Brynja'],color:'#954d37',speedMultiplier:1,wage:8,
  ...
  {id:'runesmith',name:'Runesmith',names:['Eirik','Yrsa','Runar'],color:'#546d9c',speedMultiplier:1,wage:10,
