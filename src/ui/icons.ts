import {roomLook} from '../content/rooms.ts';
...
const artwork:Record<string,string>={
 ...
 kitchen:'<path d="M20 19Q13 12 22 8M33 18Q26 11 35 5M43 19Q38 13 45 9" fill="none" stroke="#e9d8a1" stroke-width="3"/><path d="M14 29 7 27 7 36 15 39M49 29 56 27 56 36 49 39" fill="none" stroke="#c6a66a" stroke-width="4"/><path d="M13 26H51L47 46Q32 56 17 46Z" fill="url(#copper)"/><path d="M11 26Q31 16 53 26Z" fill="url(#gold)"/><path d="M29 17H35V23H29Z" fill="#ecd49a"/><path d="M24 32 26 43" stroke="#f4bc75" stroke-width="3"/>',
 workshop:'<path d="M8 22H47L56 17 52 29 41 34H29V40H44L49 49H15L20 40H27V33L15 31Z" fill="url(#steel)"/><path d="M12 23H43M23 45H42" stroke="#d2e4df" stroke-width="3"/><path d="m32 20 13-13" stroke="#b67a43" stroke-width="6"/><path d="m35 8 7-7 14 13-7 7Z" fill="url(#gold)"/>',
 training:'<path d="m17 48 28-29 6-15-15 7-28 29Z" fill="url(#steel)"/><path d="m12 35 15 15M9 49l5 5" stroke="url(#gold)" stroke-width="6"/><path d="m17 8 26 36" stroke="#8e663b" stroke-width="5"/><path d="m11 8 13-3 5 12-9 6Z" fill="url(#copper)"/>',
...
artwork.stonehand='<circle cx="32" cy="15" r="10" fill="url(#copper)"/><circle cx="32" cy="15" r="5" fill="#ffd773"/><path d="M22 28H42V44H22ZM22 30 13 39 12 47M42 30 51 39 52 47M26 44 24 57H17M38 44 40 57H47" fill="none" stroke="url(#steel)" stroke-width="4"/><path d="M32 29 37 35 32 41 27 35Z" fill="url(#gold)"/>';
artwork['summon-stonehand']=artwork.stonehand;
artwork['cave-hound']='<path d="M15 29 12 8 28 21 40 21 54 8 50 32 44 50 32 57 20 49Z" fill="url(#wood)"/><path d="M20 32 25 37M43 32 38 37" stroke="#ffd977" stroke-width="4"/><path d="M23 43 32 37 41 43 38 50H26Z" fill="url(#steel)"/><path d="M27 41H37L32 46Z" fill="#243038"/>';
artwork['notification-combat']='<path d="m12 9 7 2 31 36-6 6L13 17Z" fill="url(#steel)"/><path d="m52 9-7 2L14 47l6 6 31-36Z" fill="url(#steel)"/><path d="m10 43 12 10M42 53l12-10" stroke="url(#gold)" stroke-width="5"/>';
artwork['notification-hearth']='<path d="m32 5 17 20-8 25H23l-8-25Z" fill="#8bc7c6"/><path d="m32 5-5 23 5 22 5-22Z" fill="#d7fff2"/><path d="M12 53H52L46 59H18Z" fill="url(#gold)"/>';
artwork['notification-threat']='<path d="M14 27Q14 8 32 8Q50 8 50 27V38L40 43V53H24V43L14 38Z" fill="url(#steel)"/><path d="m20 27 10 3-4 8h-6Zm24 0-10 3 4 8h6ZM32 35l-4 8h8Z" fill="#273232"/><path d="M28 47V54M36 47V54" stroke="#273232" stroke-width="3"/>';
artwork.warrior=artwork.guard;
artwork.engineer=artwork.workshop;
artwork.runesmith=artwork.library;
artwork.miner=artwork['summon-miner'];
const defs='<defs><linearGradient id="pale" x2=".15" y2="1"><stop stop-color="#fff1d4"/><stop offset=".5" stop-color="#e0c89c"/><stop offset="1" stop-color="#9b7d50"/></linearGradient><linearGradient id="gold" x2="0.4" y2="1"><stop stop-color="#fff0b2"/><stop offset=".5" stop-color="#d7ac58"/><stop offset="1" stop-color="#806033"/></linearGradient><linearGradient id="steel" x2=".6" y2="1"><stop stop-color="#f0f7ec"/><stop offset=".45" stop-color="#9baeb0"/><stop offset="1" stop-color="#455a66"/></linearGradient><linearGradient id="wood" x2=".3" y2="1"><stop stop-color="#d5a163"/><stop offset="1" stop-color="#63402a"/></linearGradient><linearGradient id="copper" x2=".7" y2="1"><stop stop-color="#f2ca83"/><stop offset=".5" stop-color="#b87845"/><stop offset="1" stop-color="#624135"/></linearGradient></defs>';
...
// Simple carved category emblems stay distinct from the colored action artwork.
artwork['category-spells']='<path d="m32 5 8 19 19 8-19 8-8 19-8-19-19-8 19-8Z" fill="none" stroke="url(#gold)" stroke-width="5"/><path d="m32 23 9 9-9 9-9-9Z" fill="#e9d4a3"/>';
// Carved Stronghold pictograms: broad embossed silhouettes with the concept's
// ivory/bronze palette. These remain shared with the placement cursors.
artwork.treasure='<path d="M8 28Q8 15 19 15h26q11 0 11 13v24H8Z" fill="url(#gold)"/><path d="M8 31h48M19 16v34M46 16v34" fill="none" stroke="#715637" stroke-width="3"/><path d="M27 27h11v15H27Z" fill="#f3deaf"/><path d="M31 31h3v7" stroke="#51412b" stroke-width="3"/>';
artwork.dormitory='<path d="M7 11h8v45H7Zm43 15h7v30h-7Z" fill="url(#gold)"/><path d="M16 25h34v19H16Z" fill="#527185"/><path d="M17 23q0-6 6-6h4q6 0 6 6v9H17Z" fill="#efe6cc"/><path d="M33 27h16v15H33Z" fill="#7898a7"/><path d="M14 44h38v8H14Z" fill="url(#gold)"/>';
artwork.kitchen='<path d="M12 29H52L49 44Q44 56 32 56T15 44Z" fill="url(#gold)"/><path d="M12 32H5v10l10 3m37-13h7v10l-10 3" fill="none" stroke="#d3b37f" stroke-width="4"/><path d="M12 29h40M23 21q-7-6 0-13M34 22q-7-6 0-15M45 23q-7-6 0-13" fill="none" stroke="#f0ddad" stroke-width="3"/>';
artwork.workshop='<path d="M6 18H58L51 29 41 33H25L13 28Z" fill="url(#pale)"/><path d="M26 33h15v9H26ZM21 42h24l8 10H13Z" fill="url(#pale)"/><path d="M8 19h47M22 47h23" stroke="#f4e8ce" stroke-width="2"/>';
artwork.training='<path d="m9 5 9 4 34 36-7 7L11 16Zm46 0-9 4L12 45l7 7L53 16Z" fill="url(#pale)"/><path d="m8 41 14 14m20 0 14-14M8 56l6-6m36 0 6 6" fill="none" stroke="url(#gold)" stroke-width="5"/>';
artwork.library='<path d="M5 13q13-5 27 3 14-8 27-3v41q-14-5-27 2-13-7-27-2Z" fill="url(#pale)"/><path d="M32 17v37M12 23l13 3M12 32l13 3M12 41l13 3M39 26l13-3M39 35l13-3M39 44l13-3" fill="none" stroke="#695439" stroke-width="2.5"/>';
artwork.bridge='<path d="M6 23q26-17 52 0v32H47V39q-15-25-30 0v16H6Z" fill="url(#gold)"/><path d="M6 24q26-16 52 0M15 15v13m11-17v13m12-13v13m11-9v13" fill="none" stroke="#fff0c6" stroke-width="2"/>';
artwork.wall='<path d="M19 9h26v12H19ZM6 23h23v13H6Zm26 0h26v13H32ZM6 39h13v14H6Zm16 0h23v14H22Zm26 0h10v14H48Z" fill="url(#pale)"/>';
artwork['category-rooms']='<path d="M8 9h17v18H8Zm31 0h17v18H39ZM8 39h17v17H8Zm31 0h17v17H39Z" fill="none" stroke="#eee3c9" stroke-width="4"/><path d="M24 17h16M17 25v15m30-15v15M24 47h16" stroke="#eee3c9" stroke-width="5"/>';
artwork['category-defenses']='<path d="m11 14 21-8 21 8v24L32 58 11 38Z" fill="url(#pale)"/><path d="m32 17-5 13 5 17 5-17Z" fill="#423c30"/>';
artwork['category-dwarfs']='<path d="M15 26V13L32 6l17 7v13H38v-7H26v7ZM12 34l12-5 8 7 8-7 12 5v17l-12-6-8 13-8-13-12 6Z" fill="url(#pale)"/><path d="M28 27h8v8h-8Z" fill="#f0dfbe"/>';
artwork['resident-total']='<circle cx="32" cy="17" r="10" fill="url(#pale)"/><path d="M23 29h18l8 24H15Z" fill="url(#pale)"/>';
artwork['ui-home']='<path d="m5 30 27-23 27 23-7 1v24H12V31Z" fill="url(#pale)"/><path d="M27 38h10v17H27Z" fill="#292720"/>';
artwork['ui-sound']='<path d="M6 25h11L32 11v43L17 41H6Z" fill="url(#pale)"/><path d="M40 20q13 12 0 24m8-33q22 21 0 42" fill="none" stroke="#e6d2a5" stroke-width="4"/>';
artwork.sell='<path d="M8 25 27 6h26v25L32 51Z" fill="url(#gold)"/><circle cx="43" cy="17" r="4" fill="#463b2a"/><path d="M24 22v15m-6-7h13" stroke="#6d5533" stroke-width="3"/><path d="M35 48v9q12 7 23 0v-9" fill="url(#gold)"/><ellipse cx="46.5" cy="48" rx="11.5" ry="4" fill="#f3da9d"/><path d="M35 52q12 6 23 0" fill="none" stroke="#7a5b32" stroke-width="2"/>';
artwork['gold-total']='<path d="m32 5 27 27-27 27L5 32Z" fill="url(#gold)"/><path d="M32 5v27H5Z" fill="#ffe9b3"/><path d="M32 5v27h27Z" fill="#f3cb80"/><path d="M5 32h27v27Z" fill="#ddb16a"/>';
artwork.engineer=artwork.workshop;
artwork.runesmith=artwork.library;
...
export const actionCursor=(id:string)=>id==='inspect'?'default':`url("${actionIconUrl(id,true)}") 2 2, crosshair`;
